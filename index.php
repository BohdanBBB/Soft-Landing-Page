...
<?php
// Обробка форми з секції Home (GET)
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['email'])) {
    $email = htmlspecialchars($_GET['email']);
    echo "<div class='container'><p class='alert alert-success'>Email received: $email</p></div>";
}

// Обробка форми з секції Contact (POST)
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $name = htmlspecialchars($_POST['name']);
    $email = htmlspecialchars($_POST['email']);
    $message = htmlspecialchars($_POST['message']);
    echo "<div class='container'><p class='alert alert-success'>Message from $name ($email): $message</p></div>";
}
?>
               ...
               <div class="col-md-6 col-sm-6">
                    <ul class="nav nav-tabs" role="tablist">
                         <li class="active"><a href="#tab01" aria-controls="tab01" role="tab"
                                   data-toggle="tab">Responsive</a></li>
                         ...
                         <div class="tab-pane active" id="tab01" role="tabpanel">
                              <div class="tab-pane-item">
                                   ...
                                   <p>Nam feugiat a ante sollicitudin luctus. Quisque eget placerat massa. Ut quis
                                        ligula ornare, pellentesque velit eget, vestibulum est. Donec pretium tristique
                                        elit eget sodales. Pellentesque posuere.</p>
                              </div>
                              <div class="tab-pane-item">
                                   <h2>Easy to use</h2>
                         ...
                         <div class="tab-pane" id="tab03" role="tabpanel">
                              ...
                              <div class="tab-pane-item">
                                   ...
                                   <p>Quisque ullamcorper sem quis sapien cursus efficitur. Sed id sodales ipsum. Morbi
                                        eleifend tempus erat sit amet vehicula. Nulla at posuere tellus, non mattis
                                        erat. Nulla id massa gravida.</p>
                              </div>
                         </div>
                    </div>
               </div>
